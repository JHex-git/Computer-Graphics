...
void rst::rasterizer::rasterize_triangle(const Triangle& t, const std::array<Eigen::Vector3f, 3>& view_pos) 
{
    ...
    Vector3f point, interpolated_color, interpolated_normal, interpolated_shadingcoords;
    ...
    // If so, use the following code to get the interpolated z value.
                ...
                // zp *= Z;
                    ...
                    float z_interpolated = alpha * v[0].z() / t.v[0].w() + beta * v[1].z() / t.v[1].w() + gamma * v[2].z() / t.v[2].w();
                ...
                // auto interpolated_shadingcoords
                        ...
                        interpolated_color = alpha * t.color[0] / t.v[0].w() + beta * t.color[1] / t.v[1].w() + gamma * t.color[2] / t.v[2].w();
                        interpolated_color *= w_reciprocal;
                        interpolated_normal =  alpha * t.normal[0] /t.v[0].w() + beta * t.normal[1] / t.v[1].w() + gamma * t.normal[2] / t.v[2].w();
                        interpolated_normal *= w_reciprocal;
                        interpolated_texcoords = alpha * t.tex_coords[0] /t.v[0].w() + beta * t.tex_coords[1] / t.v[1].w() + gamma * t.tex_coords[2] / t.v[2].w();
                        interpolated_texcoords *= w_reciprocal;
                        interpolated_shadingcoords = alpha * view_pos[0] / t.v[0].w() + beta * view_pos[1] /t.v[1].w() + gamma * view_pos[2] / t.v[2].w();
